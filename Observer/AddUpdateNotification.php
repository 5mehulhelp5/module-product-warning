...
namespace ETechFlow\ProductWarning\Observer;
 ...
 * of Product Warning is published to the eTechFlow private Composer repo. Fires when
...
{
    private const PACKAGE     = 'etechflow/module-product-warning';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-product-warning.json';
    private const CACHE_KEY   = 'etechflow_pw_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'Product Warning';
